...
class TelefonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post telefones_url, params: { telefone: { list_id: @telefone.list_id, ramal: @telefone.ramal, telefone: @telefone.telefone } }
    end
  ...
  test "should update telefone" do
    patch telefone_url(@telefone), params: { telefone: { list_id: @telefone.list_id, ramal: @telefone.ramal, telefone: @telefone.telefone } }
